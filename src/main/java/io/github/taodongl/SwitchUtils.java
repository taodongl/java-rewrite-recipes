 ...
 */
// Copied verbatim from org.openrewrite.java.migrate.lang.SwitchUtils (rewrite-migrate-java),
// with only the package declaration changed. SwitchUtils is package-private upstream, so it cannot
// be imported across packages and must be vendored alongside the recipe.
